...
public interface TestDriveRepo extends JpaRepository<TestDrive, Long> {
    ...
    // =========================
    // STAFF VIEW / OWNER VIEW (MICROSERVICE VERSION)
    // =========================

    // ❌ Cũ: findByAssignedStaff_IdOrderByScheduleAt
    List<TestDrive> findByAssignedStaffIdOrderByScheduleAt(Long staffId);

    // ❌ Cũ: findByCreatedBy_IdOrderByScheduleAt
    List<TestDrive> findByCreatedByIdOrderByScheduleAt(Long ownerId);
